...
async function generatePDF() {
    ...
    try {
        ...
        form.getTextField('total1').setText(netPayUpper.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
        form.getTextField('tax1').setText(taxUpper.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
        form.getTextField(totalMonthField).setText(netPayUpper.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);

        // Lower section calculations
        form.getTextField(monthField).setText(netPayUpper.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
        form.getTextField(mpsMonthField).setText(netPayLower.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
        form.getTextField('MPS_total1').setText(netPayLower.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
        form.getTextField('MPS_tax1').setText(taxLower.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })).setFont(font);
